...
export function ExamTakerPage() {
        ...
        <Card>
          <div className="empty-state">
            ...
            {exam && myAttempt && score !== null && score !== undefined ? (
              <>
                <div style={{ fontSize: 32, fontWeight: 700, color: passed ? 'var(--success)' : 'var(--warning)', marginTop: 'var(--sp-2)' }}>
                  {Number(score)} / {Number(myAttempt.maxScore)}
                </div>
      ...
      <div className="page">
        ...
        <Card>
          <div className="empty-state">
            ...
            {startError && (
              <p role="alert" className="text-sm" style={{ color: 'var(--danger)', marginTop: 'var(--sp-3)', maxWidth: 480 }}>
                {startError}
              </p>
            )}
  ...
  return (
    <div className="page">
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', flexDirection: 'column', alignItems: 'flex-end', gap: 'var(--sp-2)', marginTop: 'var(--sp-3)' }}>
        {submitError && (
          <p role="alert" className="text-sm" style={{ color: 'var(--danger)' }}>
            {submitError}
          </p>
        )}
        <button type="button" className="btn primary" onClick={() => void submitAttempt()} disabled={finish.isPending}>
