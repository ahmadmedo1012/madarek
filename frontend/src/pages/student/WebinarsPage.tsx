...
const ITEMS: Webinar[] = [
  ...
  },
  {
    ...
    speakers: [
      ...
      { name: 'أ.د. فاطمة الزروقي', title: 'رئيس جامعة مدارك', org: 'جامعة مدارك', initials: 'فز', color: '#2952C8' },
    ],
    abstract:
  ...
  {
    id: 'w-p2',
    title: 'استراتيجية الصف المعكوس: نتائج تجربة جامعة مدارك',
    category: 'panel',
    scope: 'national',
    ...
    language: 'عربي',
    speakers: [
      { name: 'د. سالم البوسيفي', title: 'أستاذ مشارك', org: 'جامعة مدارك', initials: 'سب', color: '#10B981' },
      { name: 'م. أمين الزروق', title: 'مهندس المنصة الأكاديمية', org: 'جامعة مدارك', initials: 'أز', color: '#D4A537' },
    ],
    abstract:
